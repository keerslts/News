...
public abstract class PlatformPage extends OnekeySharePage {
	private cn.sharesdk.onekeyshare.themes.classic.ClassicTheme impl;
	...
	public void onCreate() {
		...
		cn.sharesdk.onekeyshare.themes.classic.PlatformPageAdapter adapter = newAdapter(cells);
		lp = new LinearLayout.LayoutParams(LayoutParams.MATCH_PARENT, adapter.getPanelHeight());
		llPanel.addView(mvp, lp);

		cn.sharesdk.onekeyshare.themes.classic.IndicatorView vInd = new cn.sharesdk.onekeyshare.themes.classic.IndicatorView(activity);
	...
	protected abstract cn.sharesdk.onekeyshare.themes.classic.PlatformPageAdapter newAdapter(ArrayList<Object> cells);

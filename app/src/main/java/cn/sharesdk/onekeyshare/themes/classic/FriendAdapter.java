...
public class FriendAdapter extends PullToRefreshListAdapter implements PlatformActionListener {
	private cn.sharesdk.onekeyshare.themes.classic.FriendListPage activity;
	...
	public FriendAdapter(cn.sharesdk.onekeyshare.themes.classic.FriendListPage activity, PullToRefreshView view) {
		super(view);
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		if (convertView == null) {
			cn.sharesdk.onekeyshare.themes.classic.FriendListItem llItem = new cn.sharesdk.onekeyshare.themes.classic.FriendListItem(parent.getContext(), ratio);
			convertView = llItem;
		}
		cn.sharesdk.onekeyshare.themes.classic.FriendListItem llItem = (cn.sharesdk.onekeyshare.themes.classic.FriendListItem) convertView;

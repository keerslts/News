...
public class PhotoMenuDetailPager extends BaseMenuDetailPager {
    ...
    public void initData() {
        ...
        String cache = CacheUtils
                .getCache(GlobalContents.PHOTOS_URL, myActivity);
    ...
    private void getDataFromServer() {
        HttpUtils utils = new HttpUtils();
         utils.send(HttpMethod.GET, GlobalContents.PHOTOS_URL,
                new RequestCallBack<String>() {
                    ...
                    public void onSuccess(ResponseInfo<String> responseInfo) {
                        ...
                        parseData(result);
                        // 设置缓存
                        CacheUtils.setCache(GlobalContents.PHOTOS_URL, result,
                                myActivity);
                    }
    ...
    class PhotoAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ViewHolder holder;
            if (convertView == null) {
                convertView = View.inflate(myActivity, R.layout.list_photo_item,
                        null);
